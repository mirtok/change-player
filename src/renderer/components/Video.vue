                ...
                case 5:
                    ...
                    if (this.videoList.length <= 1) {
                        ...
                        let index = Math.floor(
                            Math.random() * this.videoList.length
                        )
                        // 随机出来的索引等于当前视频索引
    ...
    watch: {
                ...
                this.$nextTick(() => {
                    ...
                    if (newVal) {
                        ...
                        if (
                            ...
                            this.setPlaying(false)
                            // 保存文件错误信息
                            let video = Object.assign({}, newVal, {
                                msg: '无效文件'
                            })
        ...
        volumePercent: {
            ...
            handler: function (newVal) {
                this.$nextTick(() => {
                    this.volumeTimers(
                        `${this.$t('common.volume')}：${Math.round(
                            newVal * 100
                        )}%`
                    )
