<template>
    <div
        ...
        class="playList"
        :style="{
            height: currentVideo ? `${playListHeight}px` : '100%',
    ...
    >
        <div class="my-arrow" v-show="isShowArrow">
            ...
            <span
                @click="lockList"
                v-show="
                    currentVideo && !isLock && !isHidenList && !isFullScreen
                "
                class="fa fa-lock"
        ...
        <div class="content-container" v-show="!isHidenList">
            <div class="top">
                ...
                <div class="my-icon">
                    ...
                    <span
                        ...
                        class="fa fa-trash-o fa-lg delete"
                    ></span>
                    <span
            ...
            <transition name="router" mode="out-in">
                ...
                >
                    <li :class="theme.hover" class="line">
                        {{ $t('common.clearList') }}
                    </li>
                    <li
                        ...
                        :class="{
                            [theme.hover]: true,
                            line: index == soreModeList.length - 1
                        }"
                        @click="changeSoreMode(item.soreMode)"
                    >
                        <span
                            v-show="sortMode == item.soreMode"
                            class="fa fa-check"
                        ></span>
                        {{ item.title }}
                    </li>
